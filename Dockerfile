...
ADD ./config/aqexec-pre.sh /aquadconf/aqexec-pre.sh
RUN chmod +x /aquadconf/aqexec-pre.sh
ADD ./config/aqualinkd.conf /aquadconf/aqualinkd.conf

ADD ./config/aqualinkd-docker.cmd /usr/local/bin/aqualinkd-docker
